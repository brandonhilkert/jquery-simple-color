 ...
 */
  $.fn.simpleColor = function(options) {
    ...
    options = $.extend({
      ...
      border:           this.attr('border') || '1px solid #fff',
      cellWidth:        this.attr('cellWidth') || 10,
      cellHeight:       this.attr('cellHeight') || 10,
      cellMargin:       this.attr('cellMargin') || 1,
      boxWidth:         this.attr('boxWidth') || '190px',
      boxHeight:        this.attr('boxHeight') || '25px',
    ...
    var $input = $(this);
    chooser.children(".simpleColorCell").click(function(){
      $input.val("#" + this.id)
      $input.change();
